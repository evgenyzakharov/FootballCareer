...
export const UI: Content = {
  ...
  'hud.style_against': { ru: ' · не ваш типаж', en: ' · not your kind of player' },
  ...
  // Заголовок списка, а не подпись к счётчику: турниры теперь перечисляются.
  'national.tournaments': { ru: 'Большие турниры', en: 'Major tournaments' },
  'national.won': { ru: 'титул', en: 'won' },
  'national.played': { ru: 'играл', en: 'played' },
  ...
  'timeline.yellow': { ru: 'Ж', en: 'Y' },
  'timeline.red': { ru: 'К', en: 'R' },
  'timeline.yellow_hint': { ru: 'Жёлтые карточки', en: 'Yellow cards' },
  'timeline.red_hint': { ru: 'Красные карточки', en: 'Red cards' },
  ...
  'panel.matches': { ru: 'Форма по матчам', en: 'Match form' },
